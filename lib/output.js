 ...
 * @constructor
 */
function OutputBlock (options) {
	var self = this;

	Block.apply(self, arguments);

	self.node = app.context.destination;

	return self;
}

var proto = OutputBlock.prototype = Object.create(Block.prototype);
