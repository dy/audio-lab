...
class Block extends Emitter {
	constructor (plugin, options) {
		...
		var pluginOptions = extend({}, options);
		delete pluginOptions.outputs;
		delete pluginOptions.top;
		delete pluginOptions.left;
		delete pluginOptions.label;
		delete pluginOptions.id;
